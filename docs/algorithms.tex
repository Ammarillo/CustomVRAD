...
volumetric fog grids with a screenspace shader, and lightmap post-processes
(denoising, seam stitching, edge pull).
...
Raymarching uses \code{StepCount} steps through an AABB expanded by
\code{BlendDistance} under Outside/Center blend modes. Grid resolution is
...
\ent{fog\_volume\_blocker} carves fog (soft blend) into atlas alpha and is
