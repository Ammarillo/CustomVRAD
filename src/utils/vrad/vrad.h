...
struct directlight_t
{
	...
	// light_environment / light_environment_volume tagging (see envvolume.h).
	// LIGHTENV_ID_NONE for ordinary lights; 0 = default env; 1..N = volumes.
	int		m_nEnvId;
...
#define GATHERLFLAGS_SKIP_OCCLUSION 4	// compute falloff/dots only; caller applies visibility
