...
// GMod/Hammer can emit keys longer than classic Source (32). Keep headroom so
// VRAD can load maps that still use long custom keys (e.g. light_environment_volume).
#define	MAX_KEY		128
